...
r_fil = 2000*au # Radius of the filament in AU
N_0_fil = 10**4 # Central filament number density
T_0_fil = 15 # Central prestellar core temperature in K
...
for n in range(0,len(z)-1):
    for m in range(0,len(y)-1):
        for l in range(0,len(x)-1):
            # Apply truth statement to the equation of a circle to determine whether pixel lies within the star AS WELL AS the cylinder that is the filament
