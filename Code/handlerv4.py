...
if data_type == 'sim':
	...
	'''
        ...
        for suffix in filt:
            ...
            # Run the simulation itself
            sim_data = simulation(mode='r', filt=str(suffix), npix=200, sizeau=133692, d=d, mass=mass, cloud_density=cloud_density, outside_density=outside_density, cloud_temp=cloud_temp, outside_temp=outside_temp, kappa_0=kappa_0, lambda_0=lambda_0, B=B, amr=False, dust=False)
