...
if os.path.isfile('../../../curvefitting/plw_average_data.txt') == True:
    print 'Data storage file already exists; opening now\n'
    save_data = open('../../../curvefitting/sphdata/plw_average_data.txt', 'a+')
    data_store = csv.writer(save_data, delimiter=' ')

else:
    print 'Data storage file does not already exist; writing now\n'
    save_data = open('../../../curvefitting/sphdata/plw_average_data.txt', 'w+')
    data_store = csv.writer(save_data, delimiter=' ')
