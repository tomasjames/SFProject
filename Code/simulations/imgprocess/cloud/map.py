...
hist(np.log10(N_chi_inp),bins=5,log=True,normed=True)
...
subplot2grid((6,6), (5,0), colspan=4,rowspan=1)
hist(T_chi_inp,bins=5,log=True,normed=True)
...
subplot2grid((6,6), (5,0), colspan=4,rowspan=1)
hist(np.log10(N_data_inp),bins=5,log=True,normed=True)
...
subplot2grid((6,6), (5,0), colspan=4,rowspan=1)
hist(T_data_inp,bins=5,log=True,normed=True)
