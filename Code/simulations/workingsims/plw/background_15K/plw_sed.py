...
savefig('spectrum_plw_unweighted.png', dpi=300, bbox_inches='tight')
close()
...
savefig('spectrum_plw_weighted.png', dpi=300, bbox_inches='tight')
close()
...
ylabel('Flux')
title('\nSpectral Energy Distribution for PLW Band Synthetic Data as seen by SPIRE\n')
savefig('spectrum_plw_seen.png', dpi=300, bbox_inches='tight')
close()
