...
savefig('spectrum_pmw_unweighted.png', dpi=300, bbox_inches='tight')
close()
...
savefig('spectrum_pmw_weighted.png', dpi=300, bbox_inches='tight')
close()
...
ylabel('Flux')
title('\nSpectral Energy Distribution for PMW Band Synthetic Data as seen by SPIRE\n')
savefig('spectrum_pmw_seen.png', dpi=300, bbox_inches='tight')
close()
