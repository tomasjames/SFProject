...
xlabel(r'$\nu(Hz)$')
ylabel('Transmission')
suptitle('Spectral Energy Distribution for PMW Band Synthetic Data\n')
legend(loc='best',prop={'size':9})
tight_layout()
savefig('spectrum_pmw_unweighted_v2.png', dpi=300, bbox_inches='tight')
close()
...
xlabel(r'$\nu(Hz)$')
ylabel('Flux')
title('\nSpectral Energy Distribution for PMW Band Synthetic Data as seen by SPIRE\n')
savefig('spectrum_pmw_weighted_v2.png', dpi=300, bbox_inches='tight')
close()
...
ylabel('Flux')
title('\nSpectral Energy Distribution for PMW Band Synthetic Data as seen by SPIRE\n')
savefig('spectrum_pmw_seen_v2.png', dpi=300, bbox_inches='tight')
close()
'''
