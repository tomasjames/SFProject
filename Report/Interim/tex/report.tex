...
\begin{abstract}
\textcite{RADMC-3D} is a 3-dimensional Monte Carlo radiative transfer code.
\end{abstract}
...
Dust exists throughout the Universe, permeates both the ISM and larger structures such as galaxies and molecular clouds.

\subsection{Dust in Molecular Clouds}
